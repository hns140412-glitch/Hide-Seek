(() => {
  ...
  const records={
    ...
    ocean:{supportType:'VERIFIED_ETYMOLOGY',sourceType:'ETYMONLINE',sourceRef:'https://www.etymonline.com/word/ocean',center:{label:'Okeanos',meaning:'거대한 바다·세계를 두르는 물'},nodes:[{role:'GREEK_BASE',label:'Okeanos',meaning:'고대 그리스의 거대한 바다/세계를 두르는 물'},{role:'LATIN_BASE',label:'oceanus',meaning:'그리스어에서 라틴어로 전해진 형태'},{role:'HOLD_DEEPER_ORIGIN',label:'deeper origin',meaning:'그리스어 이전의 더 깊은 기원은 확정하지 않음'}],bridge:'Okeanos → oceanus → 아주 넓은 바다 → ocean',scene:'지평선 끝까지 이어지는 거대한 바다'},
